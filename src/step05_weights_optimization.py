...
WORKERS: int = cpuCount  # Number of paralel cores by job <= total cores in cluster
...
def optimize_weights(
    ...
    solution = differential_evolution(
        ...
        workers=4*WORKERS, # BUG Este paralelismo no es compatible con Ray
...
optimals = [optimize_weights(agg_df=agg_df, df_loc=t) for t in iterate]
